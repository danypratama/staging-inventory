    ...
    <main id="main" class="main">
        ...
        <section>
            ...
            <div class="card shadow">
                <div class="card-body p-3">
                    <div class="table-responsive">
                        <div class="text-start mb-3">
                            ...
                            <button class="btn btn-info btn-detail mb-2" data-bs-toggle="modal"
                                data-bs-target="#ubahKat">
                                <i class="bi bi-arrow-left-right"></i> Ubah Kategori Invoice
                            </button>
                            <a href="#" class="btn btn-primary btn-detail mb-2" data-bs-toggle="modal"
                                data-bs-target="#addSpk">
                ...
                <div class="modal fade" id="inputSpdisc" tabindex="-1" aria-labelledby="exampleModalLabel"
                    aria-hidden="true">
                            ...
                            <div class="modal-body">
                                <form action="proses/proses-invoice-bum.php" method="POST">
                                    ...
                                    <div class="modal-footer">
                                        <button type="submit" class="btn btn-primary" name="ubah-sp">Update
                                            Kategori</button>
                    ...
                    <table class="table table-striped table-bordered" id="table3">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-end text-nowrap"><?php echo number_format($data_trx['total_harga']) ?>
                                </td>
                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <form action="proses/proses-invoice-bum.php" method="POST">
                                            ...
                                            <input type="hidden" name="id_inv" value="<?php echo $id_bum_decode ?>"
                                                readonly>
                                            <div class="mb-3">
                                                <label><strong>Harga</strong></label>
                                                <div class="input-group">
                                                    <span class="input-group-text" id="basic-addon1">Rp</span>
                                                    <input type="text" class="form-control text-end harga_produk"
                                                        name="harga_produk" id="harga_produk" required>
                                                    <input type="hidden" class="form-control text-end harga_produk"
                                                        name="qty" id="qty" required>
                                                </div>
                                            </div>
                                            <div class="modal-footer">
                                                <button type="submit" class="btn btn-primary" name="update-harga">Update
                                                    Harga</button>
                                                <button type="button" class="btn btn-secondary"
                                                    data-bs-dismiss="modal">Close</button>
                                            </div>
                        ...
                        <div class="modal fade" id="edit-diskon" tabindex="-1" aria-labelledby="exampleModalLabel"
                            aria-hidden="true">
                            <div class="modal-dialog modal-dialog-centered">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        ...
                                        <form action="proses/proses-invoice-bum.php" method="POST">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <div class="input-group">
                                                    <span class="input-group-text" id="basic-addon1">Rp</span>
                                                    <input type="text" class="form-control text-end harga_produk"
                                                        name="harga_produk" id="harga_produk_disc" required>
                                                    <input type="hidden" class="form-control text-end harga_produk"
                                                        name="qty" id="qtydisc" required>
                                                </div>
                                            </div>
                                            <div class="col-mb3">
                                                ...
                                                <div class="input-group">
                                                    <input type="text" class="form-control text-end harga_produk"
                                                        name="disc" id="discc" required>
                                                    <span class="input-group-text" id="basic-addon1">%</span>
                                                </div>
                                            </div>
                                            <div class="modal-footer">
                                                <button type="submit" class="btn btn-primary"
                                                    name="update-harga-diskon">Update Harga</button>
                                                <button type="button" class="btn btn-secondary"
                                                    data-bs-dismiss="modal">Close</button>
                                            </div>
                                        </form>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-4 mb-2">
                            <input type="hidden" name="id_inv" value="<?php echo $data_cek_harga['id_inv_bum'] ?>"
                                readonly>
                            <input type="hidden" name="id_trx[]" id="id_<?php echo $data_cek_harga['id_transaksi'] ?>"
                        ...
                        <div class="col-sm-2 mb-2">
                            <div class="input-group">
                                <span class="input-group-text" id="basic-addon1">Rp</span>
                                <input type="text" class="form-control text-end harga_produk mobile-text"
                                    name="harga_produk[]" value="<?php echo number_format($data_cek_harga['harga']) ?>"
                                    required>
                            </div>
                        </div>
                        <div class="col-sm-2 mb-2">
                        ...
                        <div class="col-sm-2 mb-2">
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control bg-light text-end mobile-text" name="qty[]"
                ...
                <div class="table-responsive">
                    ...
                    <form action="proses/proses-invoice-bum.php" method="POST">
                        <table class="table table-bordered table-striped" id="table2">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center"><input type="checkbox" name="id_spk[]"
                                            value="<?php echo $data_inv['id_spk_reg'] ?>"></td>
                        ...
                        <div class="modal-footer">
                            ...
                            <button type="submit" class="btn btn-primary" name="add-spk" id="add" disabled><i
                                    class="bi bi-plus-circle"></i> Add SPK</button>
                        </div>
                    </form>
                    <script>
                    ...
                    spkCheckboxes.forEach(function(checkbox) {
                        checkbox.addEventListener('change', function() {
                            ...
                            if (totalData + getSelectedCheckboxCount() > maxAllowed) {
                                const message = "Data Anda saat ini: " + totalData +
                                    " Anda hanya bisa menambahkan " + (maxAllowed - totalData) +
                                    " data.";
                                Swal.fire({
                                    icon: 'error',
                ...
                <div class="modal-body">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="ongkir" name="ongkir"
                            value="<?php echo number_format($ongkir) ?>" required>
                    </div>
                </div>
                <div class="modal-footer">
                    <button type="submit" class="btn btn-primary" name="update-ongkir" id="update" disabled><i
                            class="bi bi-arrow-left-right"></i> Update Ongkir</button>
                    <button type="button" class="btn btn-secondary" data-bs-dismiss="modal" id="cancel"><i
                ...
                <div class="card-body">
                    ...
                    <form action="proses/proses-invoice-bum.php" method="POST" enctype="multipart/form-data">
                        <input type="hidden" name="id_status"
                            value="STATUS-<?php echo $year ?><?php echo $month ?><?php echo $uuid ?><?php echo $day ?>">
                        <input type="hidden" name="id_inv" value="<?php echo $id_inv ?>">
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <select id="pengirim" name="pengirim" class="form-select" style="display: none;">
                                ...
                                ?>
                                <option value="<?php echo $data_driver['id_user'] ?>">
                                    <?php echo $data_driver['nama_user'] ?></option>
                                <?php } ?>
                            </select>
                        </div>
                        <div class="mb-3">
                        ...
                        <div class="modal-footer">
                            <button type="submit" class="btn btn-primary" name="ubah-dikirim" id="dikirim" disabled><i
                                    class="bi bi-arrow-left-right"></i> Ubah Status</button>
                            <button type="button" class="btn btn-secondary" data-bs-dismiss="modal"
                                id="cancelDikirim"><i class="bi bi-x-circle"> Cancel</i></button>
                        </div>
                    </form>
                </div>
            </div>
