...
<body>
    <?php
        ...
        $sql = "SELECT pr.*,
                ...
                WHERE pr.id_produk_ecat ='$id' ORDER BY nama_produk ASC";
        $result = mysqli_query($connect, $sql);
        $data = mysqli_fetch_array($result);
        $img = $data['gambar'];
        $no_img = $data["gambar"] == "" ? "gambar/upload-produk-ecat/no-image.png" : "gambar/upload-produk-ecat/$img";
    ?>
        <div class="container">
            <div class="card">
                ...
                <div class="card-body p-3">
                    <div class="row">
                        <div class="col-md-5">
                            <img alt="Gambar Produk" src="gambar/upload-produk-ecat/<?php echo $img ?>" style="height: 100%; width: 100%;" class="img-fluid">
                        </div>
                        <div class="col-md-7">
