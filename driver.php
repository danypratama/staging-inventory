...
<body>
            ...
            <div class="container-fluid">
                <div class="card">
                    <div class="card-body p-3">
                        <a href="#" class="btn btn-primary btn-md" data-bs-toggle="modal" data-bs-target="#modal1"><i class="bi bi-plus-circle"></i> Tambah data driver</a>
                        <div class="table-responsive mt-3">
                            <table class="table table-striped table-bordered" id="table1">
                                <thead>
                                    <tr class="text-white" style="background-color: #051683;">
                                        <td class="text-center p-3 col-1">No</td>
                                        <td class="text-center p-3 col-3">Nama Pengirim</td>
                                        <td class="text-center p-3 col-2">No Telpon</td>
                                        <td class="text-center p-3 col-2">Dibuat Oleh</td>
                                ...
                                <tbody>
                                    ...
                                    include "koneksi.php";
                                    $no = 1;
                                    $sql = "SELECT * FROM tb_driver LEFT JOIN user ON(tb_driver.id_user = user.id_user) ORDER BY nama_pengirim";
                                    $query = mysqli_query($connect, $sql) or die(mysqli_error($connect, $sql));
                                    while ($data = mysqli_fetch_array($query)) {
                                        $id_driver = base64_encode($data['id_driver']);
                                    ?>
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <button class="btn btn-warning btn-sm" data-bs-toggle="modal" data-bs-target="#modal2" data-id="<?php echo $data['id_driver']; ?>" data-nama="<?php echo $data['nama_pengirim']; ?>" data-telp="<?php echo $data['no_telp']; ?>">
                                                    <i class="bi bi-pencil"></i>
                                                </button>
                                                <a href="proses/proses-driver.php?hapus-driver=<?php echo $id_driver; ?>" class="btn btn-danger btn-sm delete-data"><i class="bi bi-trash"></i></a>
                                            </td>
                                            <!-- Modal Edit SP -->
                                                ...
                                                <div class="modal-dialog modal-dialog-centered">
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                            <h1 class="modal-title fs-5">Edit Data Driver</h1>
                                                            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                                        </div>
                                                        <form action="proses/proses-driver.php" method="POST">
                                                            <div class="modal-body">
                                                                <div class="mb-3">
                                                                    <div class="mb-3">
                                                                        <label class="form-label">Nama Driver</label>
                                                                        <input type="text" class="form-control" name="id_driver" id="id_driver">
                                                                ...
                                                                <div class="modal-footer">
                                                                    <button type="submit" name="edit-driver" id="simpan" class="btn btn-primary btn-md" disabled><i class="bx bx-save"></i> Simpan Perubahan</button>
    ...
    <div class="modal fade" id="modal1" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                    <h1 class="modal-title fs-5">Tambah Data Driver</h1>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <form action="proses/proses-driver.php" method="POST">
                    <div class="modal-body">
                        <div class="mb-3">
                            ...
                            <div class="mb-3">
                                <label class="form-label">Nama Driver</label>
                                <input type="hidden" class="form-control" name="id_driver" value="DRIVER<?php echo $UUID; ?>">
                        ...
                        <div class="modal-footer">
                            <button type="submit" name="simpan-driver" class="btn btn-primary btn-md"><i class="bx bx-save"></i> Simpan Data</button>
                            <button type="button" class="btn btn-secondary btn-md" data-bs-dismiss="modal"><i class="bi bi-x"></i> Tutup</button>
                        </div>
                </form>
            </div>
...
<script>
    $('#modal2').on('show.bs.modal', function(event) {
        ...
        var namaInput = modal.find('.modal-body #nama_driver');
        var telpInput = modal.find('.modal-body #telp');

        modal.find('.modal-body #id_driver').val(id);
        namaInput.val(nama);
        telpInput.val(telp);
