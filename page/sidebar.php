  ...
  <ul class="sidebar-nav">
    ...
    <li class="nav-item">
      ...
      <ul id="components-nav" class="nav-content active collapse " data-bs-parent="#sidebar-nav">
        ...
        <li>
          <a class="<?php if ($page2 == 'data-cs') {
                      echo 'active';
                    } ?>" href="data-customer.php">
        ...
        <li>
          <a class="<?php if ($page2 == 'data-produk') {
                      echo 'active';
                    } ?>" href="data-produk-reg.php">
        ...
        <li>
          <a class="<?php if ($page2 == 'data-stock-reg') {
                      echo 'active';
                    } ?>" href="stock-produk-reg.php">
            <i class="bi bi-circle"></i><span>Stock Produk Reguler</span>
          </a>
        </li>
        <li>
          <a class="<?php if ($page2 == 'data-produk-set-marwa') {
                      echo 'active';
                    } ?>" href="data-produk-set-marwa.php">
    ...
    <li class="nav-item">
      <a class="nav-link <?php if ($page == 'br-masuk') {
                            echo 'active-link';
                          } ?>" data-bs-target="#barang-masuk" data-bs-toggle="collapse" href="#">
    ...
    <li class="nav-item">
      <a class="nav-link  <?php if ($page == 'perubahan-merk') {
                            echo 'active-link';
                          } ?>" data-bs-target="#perubahan-merk" data-bs-toggle="collapse" href="#">
      ...
      <ul id="perubahan-merk" class="nav-content collapse " data-bs-parent="#sidebar-nav">
        <li>
          <a class="<?php if ($page2 == 'ganti-merk') {
                      echo 'active';
                    } ?>" href="ganti-merk-reg.php">
            <i class="bi bi-circle"></i><span>Reguler</span>
          </a>
          <a href="#">
            <i class="bi bi-circle"></i><span>E-Cat</span>
    ...
    <li class="nav-item">
      <a class="nav-link <?php if ($page == 'transaksi') {
                            echo 'active-link';
    ...
    if ($data['role'] == "Super Admin") { ?>
      ...
      <li class="nav-item">
        <a class="nav-link <?php if ($page == 'data-user') {
                              echo 'active-link';
                            } ?>" href="data-user.php">
      ...
      <li class="nav-item">
        <a class="nav-link <?php if ($page == 'role-user') {
                              echo 'active-link';
      ...
      <li class="nav-item">
        <a class="nav-link <?php if ($page == 'history-user') {
                              echo 'active-link';
