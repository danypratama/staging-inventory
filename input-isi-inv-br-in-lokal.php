            ...
            <div class="container-fluid">
                <div class="card shadow p-3">
                    ...
                    <form method="post" action="proses/proses-br-in-lokal.php" class="form">
                        <div class="row">
                            <input type="text" class="form-control" name="id_isi_inv_br_lokal" value="BR-lokal-<?php echo $year ?><?php echo $UUID ?><?php echo $month ?>">
                            <input type="text" class="form-control" name="id_isi_inv_br_lokal" value="<?php echo $id ?>">
                            <div class="col-sm-6 mb-3">
                                <label for="nama_produk">Nama Produk</label>
                                <input type="hidden" class="form-control" name="id_inv_lokal" id="id_inv_lokal" value="<?php echo $id ?>">
                        ...
                        <div class="text-end">
                            <button type="submit" name="simpan-isi-br-lokal" id="submitButton" class="btn btn-primary" disabled><i class="bx bx-save" style="color: white; font-size: 18px;"></i> Simpan Data</button>
