                ...
                <div class="card p-3">
                    ...
                    <div class="row">
                        <?php  
                            ...
                            include "koneksi.php";
                            $thn  = date('Y');
                            $sql  = mysqli_query($connect, "SELECT max(no_sph) as maxID, STR_TO_DATE(tanggal, '%d/%m/%Y') AS tgl FROM sph WHERE MONTH(STR_TO_DATE(tanggal, '%d/%m/%Y')) = '$month'");
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                <label>No. SPH</label>
                                <input type="text" class="form-control" name="no_sph" value="<?php echo $no_sph ?>" required>
                            </div>
                            <div class="mb-3">
                                <label>Tanggal</label>
