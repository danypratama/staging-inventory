          ...
          <div class="card-body p-3">
            <form action="proses/proses-produk-set-marwa.php" method="POST">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" name="nama_set_marwa" value="<?php echo $row['nama_set_marwa'] ?>" required>
                </div>
                <div class="mb-3">
                    <div class="row">
                 ...
                 <div class="mb-3">
                    <div class="row">
                        ...
                        <div class="col">
                          ...
                          <input type="text" class="form-control" name="harga" id="inputBudget" value="<?php echo $row['harga_set_marwa'] ?>" required>
                        </div>
                        <div class="col">
                            <input type="hidden" class="form-control" name="id_user" value="<?php echo $_SESSION['tiket_id'] ?>" required>
                            <input type="hidden" class="form-control" name="updated_date" id="datetime-input" required>
                        </div>
                    </div>
                </div>
