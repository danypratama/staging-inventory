        ...
        <div class="card">
          ...
          <div class="card-body p-3">
            <form action="proses/proses-produk-set-ecat.php" method="post">
              ...
              $sql = "SELECT * FROM isi_produk_set_ecat AS ipsm
                        LEFT JOIN tb_produk_ecat AS tpr ON(ipsm.id_produk = tpr.id_produk_ecat)
                        LEFT JOIN tb_merk AS tm ON (tpr.id_merk = tm.id_merk)
                        WHERE id_isi_set_ecat = '$id'";
              ...
              <div class="mb-3">
                <div class="row">
                  ...
                  <div class="mt-3">
                    ...
                    <a href="detail-set-ecat.php?detail-id=<?php echo base64_encode($data['id_set_ecat']); ?>" class="btn btn-secondary btn md"><i class="bi bi-x"></i> Batal</a>
                  </div>
                </div>
              </div>
            </form>
