...
<body>
                        ...
                        <div class="row row-cols-1 row-cols-lg-4 g-2 g-lg-3">
                            ...
                            <div class="col">
                                <div class="p-3">
                                    ...
                                    <div class="input-group flex-nowrap">
                                        <select class="form-select" id="filterSelect" onchange="filterStatusBayar()">
                                            <option value="all">Semua</option>
                            ...
                            <div class="col">
                                <div class="p-3">
                                    ...
                                    <div class="input-group flex-nowrap">
                                        <select class="form-select" id="filterStatusLunas">
                                            <option value="all">Semua</option>
                                ...
                                <div class="p-3">
                                    ...
                                    <div class="input-group flex-nowrap">
                                        <select class="form-select" id="filterSelectTagihan">
                                            <option value="all">Semua</option>
                                            <option value="Sudah">Sudah Ditagih</option>
                            ...
                            <div class="text-center border p-3">
                                ...
                                <?php 
                                    $sql_trx_tempo = "  SELECT 
                                                        ...
                                                        AND STR_TO_DATE(COALESCE(nonppn.tgl_tempo, ppn.tgl_tempo, bum.tgl_tempo), '%d/%m/%Y') <= CURDATE()
                                                        GROUP BY COALESCE(nonppn.no_inv, ppn.no_inv, bum.no_inv)
                                                        HAVING total_inv <> total_bayar";
    ...
    <?php include "finance/page/script.php" ?>
