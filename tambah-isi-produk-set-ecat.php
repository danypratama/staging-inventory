        ...
        <div class="card">
          ...
          <div class="card-body p-3">
            <form action="proses/proses-produk-set-ecat.php" method="post">
              ...
              $UUID = generate_uuid();
              ?>
              <input type="hidden" class="form-control" name="id_isi_set_ecat" value="BR-SET-MRW-<?php echo $UUID ?>">
              <input type="hidden" class="form-control" name="id_set_ecat" value="<?php echo $id_set ?>">
              <div class="mb-3">
                <div class="row">
                  <div class="col-sm-6">
                  ...
                  <div class="mt-3">
                    <button type="submit" class="btn btn-primary btn md" name="simpan-isi-set-ecat" id="simpan" disabled><i class="bx bx-save"></i> Simpan</button>
                    <a href="detail-set-ecat.php?detail-id=<?php echo base64_encode($id_set) ?>" class="btn btn-secondary btn md"><i class="bi bi-x"></i> Batal</a>
                  </div>
                </div>
              </div>
            </form>
          ...
          <table class="table table-striped table-bordered" id="table2">
            ...
            <tbody>
              ...
              $sql = "SELECT 
                      ...
                      FROM tb_produk_ecat AS tpr
                      LEFT JOIN stock_produk_ecat AS spr ON (tpr.id_produk_ecat = spr.id_produk_ecat)
