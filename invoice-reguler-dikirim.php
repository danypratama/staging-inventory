                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td class="text-center text-nowrap">
                                                        <a href="cek-produk-inv-nonppn-dikirim.php?id=<?php echo base64_encode($data['id_inv_nonppn']) ?>" class="btn btn-primary btn-sm mb-2" title="Lihat Produk"><i class="bi bi-eye-fill"></i></a>
                                                    </td>
                                                </tr>
                                                <?php $no++ ?>
                                            <?php } ?>
                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                ...
                                                <td class="text-center text-nowrap"><?php echo $no; ?></td>
                                                    ...
                                                    <td class="text-center text-nowrap"><?php echo $data['jenis_pengiriman'] ?></td>
                                                    <td class="text-center text-nowrap">
                                                        <a href="cek-produk-inv-bum-dikirim.php?id=<?php echo base64_encode($data['id_inv_bum']) ?>" class="btn btn-primary btn-sm mb-2" title="Lihat Produk"><i class="bi bi-eye-fill"></i></a>
                                                    </td>
                                                </tr>
                                                <?php $no++ ?>
                                            <?php } ?>
