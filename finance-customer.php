...
$page2 = 'spk';
include "akses.php";
include "finance/function/class-spk.php";
?>
<!DOCTYPE html>
<html lang="en">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm p-2">
                            <div class="text-center border p-3">
                                ...
                                <p><?php echo number_format($sisa_tagihan)?></p>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <table class="table table-bordered table-striped" id="table2">
                            <thead>
                                <tr class="text-white"  style="background-color: navy;">
                                    ...
                                    <td class="text-center text-nowrap p-3">Total Nominal Transaksi</td>
                                    <td class="text-center text-nowrap p-3">Total Pending Nominal</td>
                                    <td class="text-center text-nowrap p-3">Total Tagihan Transaksi</td>
                            ...
                            <?php  
                                include "koneksi.php";
                                include "finance/query/query-fnc-cs.php";
                                ...
                                <tr>
                                    ...
                                    <td class="text-center text-nowrap">
                                        <a href="detail-invoice-customer.php?date_range=year&cs=<?php echo base64_encode($data['id_customer']) ?>" class="btn btn-primary btn-sm" title="Detail Invoice">
                                            <i class="bi bi-eye"></i>
                                        </a>
                                    </td>
                                </tr>
