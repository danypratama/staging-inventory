                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td class="text-center">
                      <a href="proses/proses-stock-reg.php?hapus-stock-reg=<?php echo $data['id_stock_prod_reg']?>&id_produk=<?php echo $data['id_produk_reg']?>" class="btn btn-sm btn-danger delete-data"><i class="bi bi-trash"></i></a>
                    </td>
                  </tr>
                  <?php $no++; ?>
                  <?php } ?>
