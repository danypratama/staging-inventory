                    ...
                    <div class="table table-responsive">
                        <table class="table table-bordered table-striped" id="table2">
                            ...
                            <tbody>
                                ...
                                ?>
                                    <tr data-id="<?php echo htmlspecialchars($data['id_set_marwa']); ?>" data-nama="<?php echo htmlspecialchars($data['nama_set_marwa']); ?>" data-merk="<?php echo htmlspecialchars($data['nama_merk']); ?>">
