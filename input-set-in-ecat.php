                    ...
                    <div class="card-body p-3">
                        <form action="tampil-data-set-ecat.php" method="POST">
                            ...
                            <div class="mb-3 text-end">
                                ...
                                <a href="barang-masuk-set-ecat.php" class="btn btn-secondary btn-md"><i class="bi bi-x"></i> Tutup</a>
                            </div>
                        </form>
                    </div>
                </div>
                    ...
                    <div class="table table-responsive">
                        <table class="table table-bordered table-striped" id="table2">
                            ...
                            <tbody>
                                ...
                                $no = 1;
                                include "koneksi.php";
                                $sql = mysqli_query($connect, " SELECT tpsm.*, mr.* FROM tb_produk_set_ecat AS tpsm
