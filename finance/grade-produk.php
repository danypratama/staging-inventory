                        ...
                        <div class="table-responsive mt-3">
                            <table class="table table-striped table-bordered" id="table1">
                                ...
                                <tbody>
                                    ...
                                    include "koneksi.php";
                                    $no = 1;
                                    $sql = "SELECT * FROM tb_produk_grade AS pg JOIN user AS u ON(pg.id_user = u.id_user)";
                                    $query = mysqli_query($connect, $sql) or die(mysqli_error($connect, $sql));
                                    while ($data = mysqli_fetch_array($query)) {
                                        $id_grade = base64_encode($data['id_grade']);
                                    ?>
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <!-- Button Edit -->
                                                <button class="btn btn-warning btn-sm" data-bs-toggle="modal" data-bs-target="#modal2" data-id="<?php echo $data['id_grade'] ?>" data-grade="<?php echo $data['nama_grade']; ?>">
                                                    <i class="bi bi-pencil"></i>
                                                </button>
                                                <a href="proses/proses-grade-produk.php?hapus-grade-produk=<?php echo $id_grade; ?>" class="btn btn-danger btn-sm delete-data"><i class="bi bi-trash"></i></a>
