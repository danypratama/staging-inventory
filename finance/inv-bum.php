          ...
          <div class="table-responsive">
            <table id="table2" class="table table-striped nowrap" style="width:100%">
              ...
              <tbody>
                <?php  
                  ...
                  $sql_inv = "SELECT  bum.id_inv_bum,
                                      bum.no_inv,
                                      STR_TO_DATE(bum.tgl_inv, '%d/%m/%Y') AS tgl_inv,
                                      bum.cs_inv,
                                      STR_TO_DATE(bum.tgl_tempo, '%d/%m/%Y') AS tgl_tempo,
                                      bum.kategori_inv,
                                      bum.total_inv,
                                      ...
                                      fnc.status_lunas
                              FROM inv_bum AS bum
                              JOIN finance fnc ON (bum.id_inv_bum = fnc.id_inv)";
                 ...
                 if (isset($_GET['cs'])) {
                    ...
                    $sql_inv .= " WHERE bum.cs_inv IN ($nama_cs)";
                  }
                ...
                <tr data-status="<?php echo $data['status_pembayaran'] ?>">
                  ...
                  ?>
                  <td class="text-center">
                    <a href="detail-fnc-bum.php?id=<?php echo base64_encode($data['id_inv_bum']) ?>" class="btn btn-primary btn-sm"><i class="bi bi-eye"></i> Lihat Data</a>
                  </td>
                </tr>
                <?php $no++ ?>
                <?php } ?>
            ...
            <script>
                document.getElementById("export-button").addEventListener("click", function () {
                    ...
                    a.href = url;
                    a.download = "data-invoice-bum.xlsx";
                    a.click();
            ...
            <table class="table table-striped table-bordered" id="table3">
              ...
              <tbody>
                <?php  
                  include "koneksi.php";
                  $no = 1;
                  $sql_cs_bum = "SELECT DISTINCT cs_inv FROM inv_bum";
                  $query_cs_bum = mysqli_query($connect, $sql_cs_bum);
                  while($data_cs = mysqli_fetch_array($query_cs_bum)){
                ?>
                <tr>
