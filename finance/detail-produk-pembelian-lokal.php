            ...
            <div class="card">
                                ...
                                <table class="table table-borderless">
                                    <thead>
                                        ...
                                        <tr>
                                            ...
                                            <td class="col-md-9 text-nowrap">: <?php echo $data_inv_pembelian['no_inv'] ?></td>
                                        </tr>
                                        <tr>
                                    ...
                                    <thead>
                                        ...
                                        <?php  
                                            $status_pengiriman = $connect->query("SELECT 
                                                                                    ...
                                                                                    LEFT JOIN user us ON (skp.diambil_oleh = us.id_user)
                                                                                    WHERE id_inv_pembelian = '$id_inv_pembelian'
                                                                                ");
                ...
                <div class="col-md-12 p-3">
                    ...
                    <?php  
                        ...
                        if($total_data_pengiriman == 0) {
                            ?>
                                 <button type="button" class="btn btn-secondary btn-detail mb-3" data-bs-toggle="modal" data-bs-target="#pengiriman"><i class="bi bi-truck"></i> Pilih jenis pengiriman</button>
                            <?php
                        } else {
                            ?>
                                 <button type="button" class="btn btn-warning btn-detail mb-3" data-bs-toggle="modal" data-bs-target="#editJenisPengiriman"><i class="bi bi-pencil"></i> Edit jenis pengiriman</button>
                            <?php
                        }
                    ...
                    <div class="table-responsive mt-3">
                        <?php
                            include "koneksi.php";
                            $no = 1;
                            $sql_pembelian_produk = $connect->query("SELECT  
                                                                        pb.id_inv_pembelian,
                                                                        pb.id_inv_pembelian,
                                                                        trx.id_trx_produk,
                                                                        trx.id_produk,
                                                                    ...
                                                                    ");
                            $total_data_produk = mysqli_num_rows($sql_pembelian_produk);
                        ?>
                        <?php  
                                    ...
                                    <table class="table table-striped table-responsive" id="table2">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-end"><?php echo number_format($data_produk['total_harga']); ?></td>
                                ...
                                <form action="proses/status-kirim-pembelian.php" method="POST" enctype="multipart/form-data" id="myForm">
                                    ...
                                    <div class="mb-3 position-relative" id="diambilOleh" style="display: none;">
                                        ...
                                        <select name="diambil_oleh" class="selectize-js" id="diambil_oleh" data-type="select">
                                            ...
                                            <?php
                                            include "koneksi.php";
                                            $sql_driver = mysqli_query($connect, "SELECT us.id_user_role, us.id_user, us.nama_user, us.approval, rl.role FROM user AS us JOIN user_role rl ON (us.id_user_role = rl.id_user_role) WHERE rl.role = 'Driver' AND us.approval = '1'");
