            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form action="proses/proses-invoice-ppn.php" method="POST">
                        ...
                        include "koneksi.php";
                        $thn  = date('Y');
                        $sql  = mysqli_query($connect, "SELECT max(no_inv) as maxID, STR_TO_DATE(tgl_inv, '%d/%m/%Y') AS tgl FROM inv_ppn WHERE YEAR(STR_TO_DATE(tgl_inv, '%d/%m/%Y')) = '$thn'");
                                ...
                                <div class="col-sm-6">
                                    <div class="card-body">
                                        ...
                                        <div class="mt-3">
                                            ...
                                            <textarea type="text" class="form-control" style="height: 190px;" name="note_inv"></textarea>
                                        </div>
