                            ...
                            <table class="table table-striped table-bordered" id="table2">
                                ...
                                <tbody>
                                    ...
                                    while ($data = mysqli_fetch_array($query)) {
                                        ...
                                        $status_trx = listInvoice::getStatusTrx($data['status_trx_nonppn'], $data['status_trx_ppn'], $data['status_trx_bum']);
                                    ?>
                                        <tr>
                                            ...
                                            <td class="text-center text-nowrap">
                                                ...
                                                if ($data['jenis_inv'] == 'nonppn') {
                                                    echo '<a href="tampil-history-nonppn.php?id=' . base64_encode($data['id_inv_nonppn']) . '" class="btn btn-primary btn-sm"><i class="bi bi-eye"></i> Lihat Data</a>';
                                                } elseif ($data['jenis_inv'] == 'ppn') {
                                                    echo '<a href="tampil-history-ppn.php?id=' . base64_encode($data['id_inv_ppn']) . '" class="btn btn-primary btn-sm"><i class="bi bi-eye"></i> Lihat Data</a>';
                                                } elseif ($data['jenis_inv'] == 'bum') {
                                                    echo '<a href="tampil-history-bum.php?id=' . base64_encode($data['id_inv_bum']) . '" class="btn btn-primary btn-sm"><i class="bi bi-eye"></i> Lihat Data</a>';
                                                }
                                                ?>
                                            </td>
                                        </tr>
