            ...
            <div class="card shadow p-2">
                ...
                <?php
                    ...
                    $sql = "SELECT
                            ...
                            ppn.ongkir,
                            ppn.note_inv,
                            ppn.status_transaksi AS status_trx,
                ...
                <div class="card-body p-3">
                    <div class="table-responsive">
                        <div class="text-start mb-3">
                            ...
                            <?php  
                                $cek_bukti_terima ="SELECT ppn.id_inv_ppn, COALESCE(ibt.id_inv, 0) AS id_inv_bukti
                                                    FROM inv_ppn AS ppn 
                                                    LEFT JOIN inv_bukti_terima ibt ON(ppn.id_inv_ppn = ibt.id_inv)
                                                    WHERE ppn.id_inv_ppn = '$id_inv'";
