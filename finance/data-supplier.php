      ...
      <div class="container-fluid">
        <div class="card">
          <div class="card-body p-3">
            ...
            ?>
            <button class="btn btn-primary btn-md" data-bs-toggle="modal" data-bs-target="#modal1"><i class="bi bi-plus-circle"></i> Tambah data supllier</button>
              ...
              <table class="table table-striped table-bordered" id="table1">
                ...
                <tbody>
                  ...
                  $sql = "SELECT 
                          ...
                          LEFT JOIN user AS uc ON (sp.created_by = uc.id_user)
                          LEFT JOIN user AS uu ON (sp.updated_by = uu.id_user)
                ...
                <div class="modal-body">
                  <div class="mb-3">
                    ...
                    <div class="mb-3">
                      ...
                      <input type="text" class="form-control" name="telp_sp" id="telp">
                    </div>
                    <div class="mb-3">
      ...
      <form action="proses/proses-sp.php" method="POST">
        <div class="modal-body">
          <div class="mb-3">
            ...
            <div class="mb-3">
              <label class="form-label">Telepon</label>
              <input type="text" class="form-control" name="telp_sp">
            </div>
            <div class="mb-3">
              <label class="form-label">Email</label>
              <input type="email" class="form-control" name="email" id="email">
