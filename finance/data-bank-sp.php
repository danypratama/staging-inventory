                    ...
                    <table class="table table-bordered table-striped" id="table2">
                        <thead>
                            <tr class="text-white" style="background-color: navy;">
                                ...
                                <th class="text-center text-nowrap p-3 text-nowrap" style="width: 350px;">Nama Supplier</th>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-nowrap text-center">
                                    <button type="button" class="btn btn-warning btn-sm" data-bs-toggle="modal" data-bs-target="#edit" data-id="<?php echo $id_bank_sp ?>" data-id-bank="<?php echo $data_bank['id_bank'] ?>"  data-bank="<?php echo $data_bank['nama_bank'] ?>" data-rek="<?php echo $data_bank['no_rekening'] ?>" data-an="<?php echo $data_bank['atas_nama'] ?>">
                                        <i class="bi bi-pencil"></i>
                                    </button>
                                    <a href="proses/bank-sp.php?id=<?php echo base64_encode($id_bank_sp)?>" class="btn btn-danger btn-sm delete-data"><i class="bi bi-trash"></i></a>
                                </td>
                            </tr>
                            <?php $no++ ?>
                            <?php } ?>
                    ...
                    <form action="proses/bank-sp.php" method="POST" enctype="multipart/form-data">
                        <div class="card-body">
                            ...
                            <div class="mb-3">
                                ...
                                <select name="id_sp" class="form-select selectize-js" required>
                                    <option value=""></option>
                                    <?php  
                                        $sql_sp = "SELECT id_sp, nama_sp FROM tb_supplier ORDER BY nama_sp ASC";
                                        $query_sp = mysqli_query($connect, $sql_sp);
                                        while($data_sp = mysqli_fetch_array($query_sp)){
                                            $id_sp = $data_sp['id_sp'];
                                            $nama_sp = $data_sp['nama_sp'];
                                    ?>
                                        <option value="<?php echo $id_sp ?>"><?php echo $nama_sp ?></option>
                                    <?php } ?>
                                </select>
                            </div>
                            <div class="mb-3">
                        ...
                        <div class="modal-footer">
                            <button type="button" class="btn btn-secondary" id="btnClose" data-bs-dismiss="modal">Tutup</button>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="proses/bank-sp.php" method="post">
                        <input type="hidden" id="id" name="id_bank_sp">
                        <div class="mb-3">
