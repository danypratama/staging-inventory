                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-nowrap text-center">
                                    <button type="button" class="btn btn-warning btn-sm" data-bs-toggle="modal" data-bs-target="#edit" data-id="<?php echo $id_bank_cs ?>" data-id-bank="<?php echo $data_bank['id_bank'] ?>"  data-bank="<?php echo $data_bank['nama_bank'] ?>" data-rek="<?php echo $data_bank['no_rekening'] ?>" data-an="<?php echo $data_bank['atas_nama'] ?>">
                                        <i class="bi bi-pencil"></i>
                                    </button>
                                    <a href="proses/bank-cs.php?id=<?php echo base64_encode($id_bank_cs)?>" class="btn btn-danger btn-sm delete-data"><i class="bi bi-trash"></i></a>
                                </td>
                            </tr>
                            <?php $no++ ?>
                            <?php } ?>
