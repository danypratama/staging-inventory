                    ...
                    <table class="table table-bordered table-striped">
                        <thead>
                            <tr class="text-white" style="background-color: navy;">
                                ...
                                <th class="text-center text-nowrap p-2">Nama Bank</th>
                                <th class="text-center text-nowrap p-2">No. Rekening</th>
                                <th class="text-center text-nowrap p-2">Atas Nama</th>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-nowrap text-center"><?php echo $dekripsi_no_rek ?></td>
                                <td class="text-nowrap"><?php echo $dekripsi_atas_nama ?></td>
