            ...
            <div class="card shadow p-2">
                ...
                <?php
                    ...
                    $sql = "SELECT
                            ...
                            bum.ongkir,
                            bum.note_inv,
                            bum.status_transaksi AS status_trx,
                ...
                <div class="card-body p-3">
                    <div class="table-responsive">
                        <div class="text-start mb-3">
                            <a href="detail-invoice-customer.php?date_range=year&cs=<?php echo base64_encode($data['id_customer']) ?>" class="btn btn-warning btn-detail mb-2">
                                <i class="bi bi-arrow-left"></i> Halaman Sebelumnya
                            </a>
                            <?php  
                                $cek_bukti_terima ="SELECT bum.id_inv_bum, COALESCE(ibt.id_inv, 0) AS id_inv_bukti
                                                    FROM inv_bum AS bum 
                                                    LEFT JOIN inv_bukti_terima ibt ON(bum.id_inv_bum = ibt.id_inv)
                                                    WHERE bum.id_inv_bum = '$id_inv'";
