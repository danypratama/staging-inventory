              ...
              <div class="table-responsive">
                <table class="table table-striped table-bordered" id="table2">
                  ...
                  <tbody>
                    ...
                    include "koneksi.php";
                    $no = 1;
                    $sql = "SELECT  pr.id_produk_reg AS 'produk_id',
                                    pr.kode_produk,
                                    pr.nama_produk,
                                    pr.id_merk,
                                    pr.id_kat_penjualan,
                  ...
                  <table class="table table-striped table-bordered" id="table3">
                    ...
                    <tbody>
                      ...
                      $sql_set = "SELECT 
                                ...
                                LEFT JOIN stock_produk_reguler spr ON (tpsm.id_set_marwa = spr.id_produk_reg)
                                WHERE register_value = '0' ";
                      $query_set = mysqli_query($connect, $sql_set);
                      while ($data_set = mysqli_fetch_array($query_set)) {
                      ?>
                        <tr data-idprod="<?php echo $data_set['produk_id']; ?>" data-namaprod="<?php echo $data_set['nama_set_marwa']; ?>" data-merkid="<?php echo $data_set['id_merk']; ?>" data-katjualid="<?php echo $data_set['id_kat_penjualan']; ?>" data-merkprod="<?php echo $data_set['nama_merk']; ?>" data-bs-dismiss="modal">
                          <td class="text-center text-nowrap"><?php echo $no; ?></td>
                          <td class="text-center text-nowrap"><?php echo $data_set['kode_set_marwa']; ?></td>
                          <td class="text-start text-nowrap"><?php echo $data_set['nama_set_marwa']; ?></td>
