...
if (isset($_POST['simpan-inv'])) {
    ...
    try {
        ...
        $sql_inv = mysqli_query($connect, "INSERT INTO inv_nonppn 
            (id_inv_nonppn, no_inv, tgl_inv, cs_inv, tgl_tempo, sp_disc, kwitansi, surat_jalan, note_inv, kategori_inv, ongkir, status_transaksi, nama_invoice, user_created)
            VALUES
            ('$id_inv_nonppn', '$no_inv_nonppn', '$tgl_inv', '$cs_inv', '$tgl_tempo', '$sp_disc', '$kwitansi', '$surat_jalan', '$note_inv', '$jenis_inv', '$ongkir', '$status_inv', '$nama_invoice', '$user')");
        ...
        for ($i = 0; $i < $id_spk_count; $i++) {
            ...
            $sql_spk = mysqli_query($connect, "UPDATE spk_reg SET id_inv = '$id_inv_nonppn', no_po = '$no_po', status_spk = '$status_spk' WHERE id_spk_reg = '$id_spk_array'");
    ...
    $update_data = mysqli_query($connect, "UPDATE inv_nonppn SET cs_inv = '$cs_inv', alamat_inv = '$alamat' WHERE id_inv_nonppn = '$id_inv'");
