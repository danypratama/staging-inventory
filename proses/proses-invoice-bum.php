...
if (isset($_POST['simpan-inv'])) {
    ...
    $id_inv_bum = mysqli_real_escape_string($connect, $_POST['id_inv_bum']);
    $no_inv_bum = mysqli_real_escape_string($connect, $_POST['no_inv_bum']);
    ...
    try {
        ...
        $sql_inv = mysqli_query($connect, "INSERT INTO inv_bum 
            (id_inv_bum, no_inv, tgl_inv, cs_inv, tgl_tempo, sp_disc, kwitansi, surat_jalan, note_inv, kategori_inv, ongkir, status_transaksi, nama_invoice, user_created)
            VALUES
            ('$id_inv_bum', '$no_inv_bum', '$tgl_inv', '$cs_inv', '$tgl_tempo', '$sp_disc', '$kwitansi', '$surat_jalan', '$note_inv', '$jenis_inv', '$ongkir', '$status_inv', '$nama_invoice', '$user')");
        ...
        for ($i = 0; $i < $id_spk_count; $i++) {
            ...
            $sql_spk = mysqli_query($connect, "UPDATE spk_reg SET id_inv = '$id_inv_bum', no_po = '$no_po', status_spk = '$status_spk' WHERE id_spk_reg = '$id_spk_array'");
        ...
        $error_message = "Terjadi kesalahan saat melakukan transaksi: " . $e->getMessage();
            ...
            <script>
                ...
                Swal.fire({
                    ...
                    window.location.href = "../cek-produk-inv-bum.php?id=$id_inv_bum_encode";
                });
                });
            </script>
            <?php
    ...
    try {
        ...
        if ($jenis_pengiriman == 'Driver') { 
            ...
            $ubah_status = mysqli_query($connect, "UPDATE inv_bum SET status_transaksi = 'Dikirim', ongkir = '$ongkir' WHERE id_inv_bum = '$id_inv'");
    ...
    $update_data = mysqli_query($connect, "UPDATE inv_bum SET cs_inv = '$cs_inv', alamat_inv = '$alamat' WHERE id_inv_bum = '$id_inv'");
