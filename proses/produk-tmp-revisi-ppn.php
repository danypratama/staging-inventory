            ...
            <?php  
                ...
                if(isset($_GET['hapus_tmp'])){
                    ...
                    if($delete_data){
                        ...
                        ?>
                            <script>window.location.href = "../detail-komplain-revisi-ppn.php?id=<?php echo $id_komplain ?>"</script>
                        <?php
                    }
                        ...
                        $error_message = "Terjadi kesalahan saat melakukan transaksi: " . $e->getMessage();
                            ...
                            <script>
                                ...
                                Swal.fire({
                                    ...
                                    window.location.href = "../detail-komplain-revisi-ppn.php?id=<?php echo $id_komplain ?>";
                                });
                                });
                            </script>
                            <?php
                    ...
                    if($delete_data){
                        $_SESSION['info'] = "Dihapus";
                        ?>
                            <script>window.location.href = "../detail-komplain-revisi-ppn.php?id=<?php echo base64_encode($id_komplain) ?>"</script>
                        <?php
                    }
                        ...
                        <script>
                                document.addEventListener("DOMContentLoaded", function() {
                                    Swal.fire({
                                        ...
                                        window.location.href = "../detail-komplain-revisi-ppn.php?id=<?php echo base64_encode($id_komplain) ?>";
                                    });
                                });
                        </script>
                        <?php
