...
<?php  
    ...
    if(isset($_POST['diterima_ekspedisi'])){
        ...
        try{
            ...
            $query_update_inv_komplain = mysqli_query($connect, "UPDATE inv_komplain SET status_komplain = '1' WHERE id_komplain = '$id_komplain'");

            $query_update_inv_revisi = mysqli_query($connect, "UPDATE inv_revisi SET status_pengiriman = '1',  status_trx_komplain = '1', status_trx_selesai = '0' WHERE id_inv = '$id_inv'");
