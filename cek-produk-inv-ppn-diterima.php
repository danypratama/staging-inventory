    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <a href="proses/proses-trx-selesai.php?id_inv_ppn=<?php echo $id_inv ?>&&total_inv=<?php echo $total_inv ?> " class="btn btn-primary mb-2">
                    <i class="bi bi-check2-circle"></i> Transaksi Selesai 
                </a>
                <a href="proses/proses-trx-komplain.php?id_inv_ppn=<?php echo $id_inv ?>" class="btn btn-warning mb-2">
