        ...
        <section>
            ...
            <div class="card shadow">
                    ...
                    <div class="table-responsive">
                        <div class="text-start mb-3">
                            ...
                            $sql_cek = "SELECT
                                            ...
                                            sk.jenis_penerima
                                        FROM inv_bum AS bum
                                        LEFT JOIN status_kirim sk ON (sk.id_inv = bum.id_inv_bum)
                                        WHERE bum.id_inv_bum = '$id_inv_bum'";
                ...
                <?php  
                    ...
                    $grand_total_bum = $grand_total + $ongkir;
    ...
    <div class="modal fade" id="diambil" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <form action="proses/proses-diambil-oleh-bum.php" method="POST" enctype="multipart/form-data">
                    <div class="modal-body">
                        <input type="hidden" name="id_inv" value="<?php echo $id_bum_decode ?>">
                        <div class="mb-3">
                ...
                <div class="modal-body">
                    <div class="card-body">
                        <form action="proses/proses-ubah-ongkir-resi.php" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="modal-footer">
                                <button type="submit" class="btn btn-primary" name="ubah-ongkir-bum"><i class="bi bi-arrow-left-right"></i> Ubah Data</button>
...
document.addEventListener("DOMContentLoaded", function () {
    ...
    cancelButton.addEventListener("click", function () {
        ...
        document.getElementById("resi").value = "<?php echo $no_resi ?>";
        document.getElementById("ongkos_kirim").value = "<?php echo number_format($ongkir) ?>";

        // Close the modal dialog
        var modal = document.getElementById("editOngkir");
